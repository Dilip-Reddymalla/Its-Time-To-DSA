...
const ProgressView = () => {
  ...
  if (loading) {
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '60vh' }}>
        ...
        <p style={{ marginTop: '24px', color: 'var(--zinc-)' }}>Calculating your mastery...</p>
      </div>
    );
  }
  ...
  if (!stats) {
    return (
      <div style={{ color: 'var(--zinc-)', padding: '40px', textAlign: 'center' }}>
  ...
  return (
    <div className="reveal visible container" style={{ paddingBottom: '80px', paddingTop: 'clamp(20px, 5vw, 40px)' }}>
      <div style={{ marginBottom: '40px' }}>
        ...
        <p style={{ color: 'var(--zinc-)', fontSize: 'clamp(0.9rem, 2vw, 1.1rem)' }}>Tracking your consistency and pattern recognition.</p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(clamp(160px, 30vw, 220px), 1fr))', gap: '24px', marginBottom: '32px' }}>
        <div className="glass-card" style={{ padding: 'clamp(20px, 4vw, 32px)', textAlign: 'center' }}>
          <div style={{ color: 'var(--zinc-)', fontSize: '0.75rem', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '12px' }}>Consistency</div>
          <div style={{ fontSize: 'clamp(2rem, 6vw, 3rem)', fontWeight: '900', color: 'var(--amber-500)', marginBottom: '4px' }}>{stats.currentStreak} <span style={{ fontSize: '1rem', fontWeight: '600', color: 'var(--zinc-)' }}>Days</span></div>
          <p style={{ color: 'var(--zinc-)', fontSize: '0.875rem' }}>Current Streak</p>
        </div>
        <div className="glass-card" style={{ padding: 'clamp(20px, 4vw, 32px)', textAlign: 'center' }}>
          <div style={{ color: 'var(--zinc-)', fontSize: '0.75rem', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '12px' }}>Total Impact</div>
          <div style={{ fontSize: 'clamp(2rem, 6vw, 3rem)', fontWeight: '900', color: 'var(--accent-primary)', marginBottom: '4px' }}>{stats.totalSolved}</div>
          <p style={{ color: 'var(--zinc-)', fontSize: '0.875rem' }}>Problems Conquered</p>
        </div>
        <div className="glass-card" style={{ padding: 'clamp(20px, 4vw, 32px)', textAlign: 'center' }}>
          <div style={{ color: 'var(--zinc-)', fontSize: '0.75rem', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '12px' }}>Persistence</div>
          <div style={{ fontSize: 'clamp(2rem, 6vw, 3rem)', fontWeight: '900', color: 'var(--emerald-500)', marginBottom: '4px' }}>{stats.daysActive}</div>
          <p style={{ color: 'var(--zinc-)', fontSize: '0.875rem' }}>Sessions Logged</p>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(clamp(280px, 45vw, 400px), 1fr))', gap: '32px' }}>
        ...
        <div className="glass-card" style={{ padding: 'clamp(20px, 4vw, 32px)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
            ...
            <span style={{ fontSize: '0.75rem', color: 'var(--cobalt-400)', fontWeight: 'bold' }} className="hide-mobile">TOP PERFORMER</span>
          </div>
              ...
              Object.entries(stats.topicBreakdown)
                ...
                <div key={topic}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.875rem', marginBottom: '8px' }}>
                    ...
                    <span style={{ color: 'var(--zinc-)', fontWeight: '500' }}>{data.total} solved</span>
                  </div>
                ...
                <div style={{ color: 'var(--zinc-)', textAlign: 'center', marginTop: '60px', opacity: 0.5 }}>
